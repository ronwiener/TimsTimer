...
import cropedOp from "./assests/cropedOp.jpg";
...
const useStyles = makeStyles({
  bike: {
    marginTop: 0,
    //backgroundImage: `url("https://res.cloudinary.com/ron7602/image/upload/v1636639496/timers/TimsBike.jpg")`,
    backgroundImage: `url(${cropedOp})`,
    height: "100vh",
    textAlign: "center",
      ...
      <Grid container direction="column">
        <Grid item container className={classes.bike}>
          ...
          <Grid
            ...
            container
            direction="column"
            style={{ marginTop: matchesSM ? 30 : 40 }}
          >
